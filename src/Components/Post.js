...
import background from "./post-bg.jpg";
      ...
      <div className="row">
        <div className="col-lg-8 col-md-10 mx-auto">
          ...
          <p>Placeholder text by
            <Link to="http://spaceipsum.com/">Space Ipsum</Link>. Photographs by
            <Link to="https://www.flickr.com/photos/nasacommons/">NASA on The Commons</Link>.</p>
        </div>
      </div>
    </div>
  </article>
